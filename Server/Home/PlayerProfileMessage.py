    ...
    def encode(self):
        ...
        for brawler, unlocked in brawlerData["UnlockedBrawlers"].items():
            if unlocked:
                ...
                self.writeVint(1 + int(brawlerData["brawlerPowerLevel"][str(brawler)]))  # power lvl
        ...
        self.writeVint(15)
        self.writeVint(player[1])  # most challenge wins 15

        self.writeVint(16)
        self.writeVint(0) # Зомбик?? 20
